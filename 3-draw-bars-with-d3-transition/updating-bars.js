async function drawBars() {
  ...
  const drawHistogram = metric => {
    ...
    // global transtions control the root html
    const exitTransition = d3.transition().duration(600)
    // by chaining our update to the exit it will only happen afterwood
    ...
    // we need to use style here to create an inline style
    // that will override the CSS in style.css. We cant use fill
    // because SVG styles (ie fill) are overriden by CSS styles.
